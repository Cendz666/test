...
/**
 * Servlet implementation class RenewBookServlrt
 */
@WebServlet(description = "显示能够续借的书", urlPatterns = { "/RenewBookServlet" })
public class RenewBookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user==null){
			...
			request.getRequestDispatcher("lendInfo/renewBook.jsp").forward(request,response);
		}	
		}
