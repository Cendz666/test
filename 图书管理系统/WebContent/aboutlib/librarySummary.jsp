...
<img src="<%=request.getContextPath()%>/images/image5.jpg" id="gztsg"/>
<div class="right" style="position:relative;top:20px;">
<p style="margin:10px;text-indent:25px;font-size:20px;color:black;line-height:30px;"><%= library.getSummary() %></p>
</div>
</div>
