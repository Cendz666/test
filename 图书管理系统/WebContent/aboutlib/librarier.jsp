...
<table>
<tr>
<td>馆长姓名:</td><td><%= library.getLibrarier() %></td></tr>

<tr>
<td>馆长联系方式:</td><td><%= library.getLinkTel() %></td></tr>

<tr>
<td>馆长邮箱:</td><td><%= library.getLinkEmail() %></td></tr>

<tr>
<td>馆长地址:</td><td><%= library.getLinkAddress() %></td></tr>
<tr>
</table>
</div>
</div>
